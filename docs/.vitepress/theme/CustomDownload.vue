    ...
    <section>
      <div>
        <div class="section-header">
          ...
          <p>Shows all the releases from latest version to older version.</p>
          <p><b>(Latest Version is recommended)</b></p>
          <a :href="releaseUrl" class="btn-archive btn-primary" @click="trackDownload('release')">
...
const releaseUrl = 'https://github.com/vishnumur777/mybatop/releases'
